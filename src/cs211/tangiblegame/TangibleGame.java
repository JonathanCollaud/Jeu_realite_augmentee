...
public class TangibleGame extends PApplet {
	...
	public void draw() {
		...
		if (GAME_MODE_TANGIBLE) {
			...
			// On applique les diffÃ©rents filtres Ã  la suite
	...
	private void playGame() {
		...
		if (!paused) {
			...
			if (paused) {
				...
				// On va corriger la position 3D de la souris par rapport ï¿½
				// oï¿½
	...
	// Vï¿½rifie quï¿½on puisse poser le cylindre (pas en dehors du terrain, ou
	// sur
	// la balle)
	...
	// Graphics drawing
	void drawGameWindow() {
		// CamÃ©ra et Ã©clairage
		gameWindow.beginDraw();

		gameWindow.noStroke(); // dÃ©sactive l'affichage des lignes extÃ©rieures
